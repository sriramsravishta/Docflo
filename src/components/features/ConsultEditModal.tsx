          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="rounded-lg py-4">
                <AutoResizeTextarea value={editedDiagnosisText} onChange={(e) => setEditedDiagnosisText(e.target.value)} minRows={3} maxHeight={240} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="rounded-lg py-4">
                <AutoResizeTextarea value={editedTreatmentText} onChange={(e) => setEditedTreatmentText(e.target.value)} minRows={3} maxHeight={240} />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={onAddMedicine} className="btn-secondary flex items-center space-x-2">
                  <Plus className="w-4 h-4" /><span>Add Medicine</span>
                </button>
              </div>
                  ...
                  return (
                    <div key={medicine.id} className="bg-[#FAFAFA] border border-gray-200 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button onClick={() => onDeleteMedicine(medicine.id)} className="text-red-600 hover:text-red-800">
                      ...
                      <div className="flex flex-wrap gap-3 items-end">
                        <div className="relative min-w-[250px] flex-1">
                          ...
                          <input
                            type="text"
                            value={d.name}
                            onChange={(e) => { updateMedicineDraft(medicine.id, { name: e.target.value }); onMedicineSearch(e.target.value); }}
                            ...
                            <div className="absolute z-30 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                              {medicineSearchResults.map((result, idx) => (
                                <button
                                  key={idx}
                                  type="button"
                                  onClick={() => { updateMedicineDraft(medicine.id, { name: result.name }); setMedicineSearchResults([]); }}
                        ...
                        <div className="min-w-[120px] flex-1">
                          ...
                          <input type="text" value={d.dosage} onChange={(e) => updateMedicineDraft(medicine.id, { dosage: e.target.value })} className="input-field" placeholder="e.g.500 mg" />
                        </div>

                        <div className="min-w-[120px] flex-1">
                          <label className="block text-sm font-medium text-gray-700 mb-1">Quantity</label>
                          <input type="text" value={d.quantity} onChange={(e) => updateMedicineDraft(medicine.id, { quantity: e.target.value })} className="input-field" placeholder="e.g.1 tab" />
                        </div>

                        <div className="min-w-[120px] flex-1">
                          <label className="block text-sm font-medium text-gray-700 mb-1">Type</label>
                          <input type="text" value={d.type} onChange={(e) => updateMedicineDraft(medicine.id, { type: e.target.value })} className="input-field" placeholder="e.g.Tablet" />
                        </div>

                        <div className="min-w-[120px] flex-1">
                          <label className="block text-sm font-medium text-gray-700 mb-1">Frequency</label>
                          <select value={d.frequency} onChange={(e) => updateMedicineDraft(medicine.id, { frequency: e.target.value })} className="input-field">
                        ...
                        <div className="min-w-[120px] flex-1">
                          ...
                          <select value={d.food} onChange={(e) => updateMedicineDraft(medicine.id, { food: e.target.value })} className="input-field">
                        ...
                        <div className="min-w-[120px] flex-1">
                          ...
                          <input type="text" value={d.duration} onChange={(e) => updateMedicineDraft(medicine.id, { duration: e.target.value })} className="input-field" placeholder="e.g.7 days" />
                        </div>
                        ...
                        <div className="min-w-[250px] flex-1">
                          ...
                          <input type="text" value={d.instructions} onChange={(e) => updateMedicineDraft(medicine.id, { instructions: e.target.value })} className="input-field" placeholder="e.g.AF" />
                        </div>
                      </div>
                    </div>
                  );
            ...
            <div>
              ...
              <div className="rounded-lg py-4">
                <AutoResizeTextarea value={editedInvestigationsText} onChange={(e) => setEditedInvestigationsText(e.target.value)} minRows={3} maxHeight={240} />
              </div>
            </div>
