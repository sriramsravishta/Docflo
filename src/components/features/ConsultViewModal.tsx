    ...
    <>
      ...
      {!isEditing ? (
        ...
        <textarea
          ...
          className="w-full px-2 py-1 rounded-lg text-[16px] whitespace-pre-line resize-none border border-gray-300 bg-gray-50 text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#024CDB]"
