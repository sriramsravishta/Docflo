...
setConsultMedicines(consultMedicines.map((med) => ([med.id](http://med.id/) === medicineId ? updatedMedicine : med)));
} catch (error) {
...
<td className="border border-gray-300 px-3 py-2 text-gray-800">{[med.name](http://med.name/) || '-'}</td>
