...
import { Plus, Search, Mic, Settings, Filter, Columns3, ChevronDown, ChevronRight, Phone, Calendar, User } from 'lucide-react';
         ...
         <section>
           ...
           {activeTab === 'today' && (
              ...
              <SummaryTab docId={user.id} />
                        ...
                        {activeTab === 'leads' && hasLeadsFeature && user?.id && (
              <LeadsTab docId={user.id} onCreateAppointment={handleCreateFromLead} />
            )}
          </section>
          ...
          <section>
            ...
            {loading ? (
              ...
              <EmptyState message="No patients found" />
                                                     ...
                                                     <AllPatientsTable patients={filteredAllPatients} formatDate={formatDate} userId={user?.id} showColPicker={showColPicker} setShowColPicker={setShowColPicker} />
            )}
          </section>
        </div>
      </div>
