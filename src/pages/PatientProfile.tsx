...
try {
const ids = pending.map((p) => [p.id](http://p.id/));
...
setProcessingPreConsults((prev) => {
if (prev.some((x) => [x.id](http://x.id/) === [row.id](http://row.id/))) {
return prev.map((x) => ([x.id](http://x.id/) === [row.id](http://row.id/) ? { ...x, ...row } : x));
}
return [row, ...prev];
});
};
...
useEffect(() => {
if (selectedConsult && [selectedConsult.id](http://selectedconsult.id/)) {
loadConsultMedicines([selectedConsult.id](http://selectedconsult.id/));
}
...
.from('consult')
.select('id, consult_summary_final, created_at')
.eq('id', [selectedConsult.id](http://selectedconsult.id/))
.single();
...
.eq('id', [editingVital.id](http://editingvital.id/));
...
name: [editForm.name](http://editform.name/),
...
setEditedConsult({
...summary,
id: [selectedConsult.id](http://selectedconsult.id/),
});
...
const d = medicineDrafts[[m.id](http://m.id/)];
if (!d) continue;
...
await loadConsultMedicines([selectedConsult.id](http://selectedconsult.id/));
}
};
...
consult_id: [selectedConsult.id](http://selectedconsult.id/),
name: '',
dosage: '',
quantity: '',
type: '',
...
setConsultMedicines(consultMedicines.filter((med) => [med.id](http://med.id/) !== medicineId));
...
await updatePreConsult([preConsult.id](http://preconsult.id/), {
...
id: [preConsult.id](http://preconsult.id/),
documents_uploaded: uploadedUrls,
ai_summary: null,
...
<div
key={[consult.id](http://consult.id/)}
...
<div key={[vital.id](http://vital.id/)}>
...
const d = medicineDrafts[[medicine.id](http://medicine.id/)] || {
name: [medicine.name](http://medicine.name/) || '',
...
<input
type="text"
value={[d.name](http://d.name/)}
onChange={(e) => {
updateMedicineDraft([medicine.id](http://medicine.id/), { name: e.target.value });
...
type="text"
value={d.dosage}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { dosage: e.target.value })}
className="input-field"
...
type="text"
value={d.quantity}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { quantity: e.target.value })}
className="input-field"
...
type="text"
value={d.type}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { type: e.target.value })}
className="input-field"
...
<select
value={d.frequency}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { frequency: e.target.value })}
className="input-field"
>
...
<select
value={d.food}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { food: e.target.value })}
className="input-field"
>
...
<div
ref={openTimeDropdownId === [medicine.id](http://medicine.id/) ? timeDropdownRef : null}
className="relative"
>
<button
type="button"
onClick={() =>
setOpenTimeDropdownId(openTimeDropdownId === [medicine.id](http://medicine.id/) ? null : [medicine.id](http://medicine.id/))
}
...
type="text"
value={d.duration}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { duration: e.target.value })}
className="input-field"
...
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { instructions: e.target.value })}
className="input-field"
...
type="text"
value={d.flags}
onChange={(e) => updateMedicineDraft([medicine.id](http://medicine.id/), { flags: e.target.value })}
className="input-field"
